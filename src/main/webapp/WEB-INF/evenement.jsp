...
<main role="main" class="container">
        ...
        <div class="float-right">
            <%
                if(utilisateur.getRole().getAccesEcriture())
                    out.println("<a href='modification-evenement?nom="+evenement.getNom()+"&date="+evenement.getDate()+"' class='btn btn-ensibs btn-sm' role='button'>Modifier l'évènement</a>");%>
        </div>
    ...
    <a href="evenements" class="btn btn-secondary mb-4"> Retour</a>
</main>
