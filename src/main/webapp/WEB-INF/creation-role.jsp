...
<main role="main" class="container">
    <div>
        ...
        <div>
            ...
            <form class="form-signin" method="post" action="creation-role">
                <div class="form-row">
                    <div class="form-group col-md-2">
                        ...
                        <input type="checkbox" class=form-control" id="ecriture" name="ecriture" value="Ecriture" required>
                    </div>
                </div>
                <hr width="100%">
                <button type="submit" class="btn btn-ensibs mb-4">Créer</button>
                <a href="gestionRoles" class="btn btn-secondary mb-4"> Retour</a>
            </form>
