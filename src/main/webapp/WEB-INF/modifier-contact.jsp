...
<body class="page_body">
    ...
    <main role="main" class="container">
        <div>
            ...
            <div>
                ...
                <form id="modifier-contact" class="form-signin" method="post" action="modifier-contact">
                    <div class="form-row">
    ...
    <script>
        function callModifierContact(){
            document.getElementById("modifier-contact").action = "modifier-contact"
            document.getElementById("modifier-contact").submit;
        }
        function callCreationEntreprise(){
            document.getElementById("modifier-contact").action = "creation-entreprise-from-contact"
            document.getElementById("modifier-contact").submit;
        }
    </script>
</body>
