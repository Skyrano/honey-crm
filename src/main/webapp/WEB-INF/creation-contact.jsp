...
<body class="page_body">
    ...
    <main role="main" class="container">
        ...
        <div>
            ...
            <div>
                ...
                <form class="form-signin" id="creation-contact" method="post" action="creation-contact">
                    <div class="form-row">
    ...
    <script>
        function callCreationContact(){
            document.getElementById("creation-contact").action = "creation-contact"
            document.getElementById("creation-contact").submit;
        }
        function callCreationEntreprise(){
            document.getElementById("creation-contact").action = "creation-entreprise-from-contact"
            document.getElementById("creation-contact").submit;
        }
    </script>
