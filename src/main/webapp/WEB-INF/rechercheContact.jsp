...
<main role="main" class="container">
    <div>
        ...
        <div>
            ...
            <form class="form-signin" method="post" action="rechercherContact">
                <div class="form-row">
                ...
                <div class="row">
                    ...
                    <a href='contacts' class='btn btn-ensibs ml-4 mb-4'role='button'>Tous les contacts</a>
                    <%
                        if(utilisateur.getRole().getAccesEcriture())
                    out.println("<a href='creation-contact' class='btn btn-ensibs ml-4 mb-4' role='button'>Créer un contact</a>");%>
