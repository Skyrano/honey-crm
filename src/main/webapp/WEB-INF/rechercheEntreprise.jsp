...
<main role="main" class="container">
    <div>
        ...
        <div>
            ...
            <form class="form-signin" method="post" action="rechercherEntreprise">
                <div class="form-row">
                ...
                <div class="row">
                    ...
                    <a href='entreprises' class='btn btn-ensibs ml-4 mb-4' role='button'>Toutes les entreprises</a>
                    <%
                        if(utilisateur.getRole().getAccesEcriture())
                            out.println("<a href='creation-entreprise' class='btn btn-ensibs ml-4 mb-4' role='button'>Créer une entreprise</a>");%>
