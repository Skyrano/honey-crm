...
<main role="main" class="container">
    ...
    %>
    <div class="card-body">
        <a href="creation-role" class="btn btn-ensibs">Créer un rôle</a>
...
<script>
    ...
    $('#modalSuppr').on('show.bs.modal', function (event) {
        ...
        btn.href = "supprimerRole?idSuppression=" + recipient

        <%DAO dao = DAO.getDAO();
        dao.log(LogType.SUPPRESSION_ROLE, "suppression d'un role", utilisateur);
        %>
    })
</script>
</body>
