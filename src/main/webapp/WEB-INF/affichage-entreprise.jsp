    ...
    <main role="main" class="container">
            ...
            <div class="form-group col-md-2">
                <%
                    if(utilisateur.getRole().getAccesEcriture())
                        out.println("<td><a href='modifier-entreprise?idEntreprise="+request.getParameter("idEntreprise")+ "' class='btn btn-success btn-ensibs btn-sm' role='button'>Modifier</a></td>");%>
        ...
        <div class="form-row">
            <div class="form-group col-md-8">
                ...
                <form action='mail' method='post' id="formMail">
