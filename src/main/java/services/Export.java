    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        if (utilisateur!= null && (utilisateur.getRole() != null && utilisateur.getRole().getNom().equals("admin")) ) {
            ...
            for (Contact cont : dao.listeContacts()) {
                ...
                List<Categorie> categories = dao.recupererCategorieParContact(cont.getIdentifiant());
                String cat = "";
                ...
                contact.append(cat + ";");
                List<Commentaire> commentaires = dao.recupererCommentairesParContact(cont.getIdentifiant());
                String comm = "";
                for (int i = 0; i < categories.size(); ++i) {
            ...
            dao.log(LogType.EXPORT_CSV, "export de la base de données",utilisateur);
            writer.close();
            outStream.close();
        }else
