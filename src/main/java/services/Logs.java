            ...
            if (utilisateur != null && (utilisateur.getRole() != null && utilisateur.getRole().getNom().equals("admin"))){
                ...
                for (Log log:logs){
                    listing+=
                                    ...
                                    "                <td><a href='afficherUtilisateur?identifiant="+log.getUtilisateurConcerne().getIdentifiant()+"'>"+log.getUtilisateurConcerne().toString()+"</a></td>" +
                                    "            </tr>\n";
                }
                listing+=
                        "            </tbody>\n" +
                ...
                this.getServletContext().getRequestDispatcher("/WEB-INF/logs.jsp").forward(request,response);
            }
            else {
